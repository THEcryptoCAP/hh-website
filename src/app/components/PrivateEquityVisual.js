...
export default function PrivateEquityVisual({ className = "" }) {
  ...
  return (
    ...
    >
      {/* Professional Private Equity Visual */}
      <div className="relative overflow-hidden rounded-2xl shadow-2xl">
        {/* HD Image Container with Glide Animation */}
        <div className="w-full h-80 relative overflow-hidden">
          {/* Luxury Interior Image with Glide Effect */}
          <img 
            src="/images/luxury-interior-private-equity.jpg" 
            alt="Luxury Private Equity Interior - Strategic Growth Environment"
            ...
            onError={(e) => {
              ...
              e.target.style.backgroundImage = `linear-gradient(135deg, #1f2937 0%, #374151 100%)`;
          ...
          <div 
            className="w-full h-full bg-gradient-to-br from-gray-800 via-gray-700 to-gray-800 relative hidden"
            style={{
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center text-white">
                ...
                <p className="text-sm font-medium text-white/95 uppercase tracking-wider mb-1">Private Equity</p>
                <p className="text-xs text-white/80">Strategic Growth</p>
              </div>
            </div>
          </div>
        ...
        <div 
          className="absolute inset-0 bg-gradient-to-t from-black/25 via-transparent to-transparent transition-all duration-700"
          style={{
